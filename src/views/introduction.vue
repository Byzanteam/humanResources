<template>
  <div class="introduction">
    ...
    <div ref="talent-rank" data-content="根据活动要求需要的人才类型进行统计分析" :style="{color: '#fff', fontSize: '18px', fontWeight: '600', textAlign: 'left', letterSpacing: '1px', cursor: 'pointer', position: 'absolute', top: '380px', left: '1536px'}">
      引进人才职称分布
    </div>
