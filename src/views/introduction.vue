<template>
  <div class="introduction">
    ...
    <data-loader ref="activity-number-line" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/44b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${selectedArea}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '240px', position: 'absolute', top: '334px', left: '40px'}">
    ...
    <data-loader ref="high-level-talent-bar" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/46b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${selectedArea}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '240px', position: 'absolute', top: '794px', left: '40px'}">
    ...
    <data-loader ref="introduce-place" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/48b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${selectedArea}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '218px', position: 'absolute', top: '100px', left: '1500px'}">
    ...
    <data-loader ref="talent-rank" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/49b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${selectedArea}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '218px', position: 'absolute', top: '432px', left: '1500px'}">
    ...
    <data-loader ref="education_rank" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/4ab74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${selectedArea}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '296px', height: '270px', overflow: 'scroll', position: 'absolute', top: '752px', left: '1542px'}">
    ...
    <data-loader ref="activity-number-digital" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/43b74ddd-39de-493f-84ab-9d87fcf23fee/data?year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}&area=${selectedArea}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '258px', left: '154px'}">
    ...
    <data-loader ref="high-level-talent-digital" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/45b74ddd-39de-493f-84ab-9d87fcf23fee/data?year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}&area=${selectedArea}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '718px', left: '130px'}">
    ...
    <data-loader @requestDone="(param)=>[setState('dateRange', param.results ? param.results.map((item) => (Number(item[0]))) : [])]" url="http://vis.cdyoue.com:35006/v1/components/42b74ddd-39de-493f-84ab-9d87fcf23fee/data" method="get" :data="[['']]">
