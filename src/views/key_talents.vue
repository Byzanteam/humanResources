<template>
  <div class="key_talents">
    ...
    <div>
      <data-loader ref="job_select" @requestDone="(exports)=>[setState('dateRange', exports.results ? exports.results.map((item) => (Number(item[0]))) : [])]" url="http://vis.cdyoue.com:35006/v1/components/02b74ddd-39de-493f-84ab-9d87fcf23fee/data" method="get" :data="[['']]" :style="{position: 'absolute', top: '270px', left: '1503px'}">
      ...
      <data-loader ref="industry_select" v-slot="{ results: results }" url="http://vis.cdyoue.com:35006/v1/components/30b74ddd-39de-493f-84ab-9d87fcf23fee/data?offset=10" method="get" :data="[['']]" :style="{position: 'absolute', top: '270px', left: '1697px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/28b74ddd-39de-493f-84ab-9d87fcf23fee/data?industry=${craneStates.currentShortageType|| ''}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '180px', overflow: 'scroll', position: 'absolute', top: '845px', left: '40px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/33b74ddd-39de-493f-84ab-9d87fcf23fee/data?industry=${craneStates.currentShortageType|| ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date(Date.now()).getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '180px', overflow: 'scroll', position: 'absolute', top: '845px', left: '1500px'}">
    ...
    <data-loader ref="high-talents-demand-change-line-chart" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/32b74ddd-39de-493f-84ab-9d87fcf23fee/data?industry=${craneStates.currentShortageType|| ''}`" method="get" :data="[['暂无数据', 0]]" :style="{width: '380px', height: '214px', position: 'absolute', top: '518px', left: '1500px'}">
...
export const key_talents = {
  ...
  computed: {
    ...
    supplyUrl() {
      return `http://vis.cdyoue.com:35006/v1/components/25b74ddd-39de-493f-84ab-9d87fcf23fee/data?job=${this.craneStates.supplyInputWord}&area=${this.craneStates.department ? this.craneStates.department.label : ''}`
    },
    demandUrl() {
