<template>
  <div class="key_talents" v-if="isShow">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/55b74ddd-39de-493f-84ab-9d87fcf23fee/data?type=${digitalKeyword || ''}&tag=${craneStates.supplyInputWord}&area=${currentArea ? currentArea : ''}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '94px', left: '106px'}">
    ...
    <div :style="{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', width: '120px', position: 'absolute', top: '163px', left: '50px'}">
      ...
      <data-loader v-slot="{ results: results }" :url="`/v1/components/56b74ddd-39de-493f-84ab-9d87fcf23fee/data?type=${digitalKeyword || ''}&tag=${craneStates.supplyInputWord}&area=${currentArea ? currentArea : ''}`" method="get" :data="[[0]]">
    ...
    <div :style="{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', width: '120px', position: 'absolute', top: '163px', left: '170px'}">
      ...
      <data-loader v-slot="{ results: results }" :url="`/v1/components/57b74ddd-39de-493f-84ab-9d87fcf23fee/data?type=${digitalKeyword || ''}&tag=${craneStates.supplyInputWord}&area=${currentArea ? currentArea : ''}`" method="get" :data="[[0]]">
        <digital-roll :content="{digital: results[0][0] ? results[0][0] : 0, suffix: '人'}" :options="{separator: ''}" :suffixStyle="{color: '#00fff2', fontSize: '16px', fontWeight: '400'}" :titleStyle="{color: '#ffffff', fontSize: '16px', fontWeight: '400'}" :digitalStyle="{fontSize: '20px', color: '#00fff2', fontWeight: '600', lineHeight: '32px', fontFamily: 'Oswald-Regular', format: '11', letterSpacing: '2.4px'}" />
      </data-loader>
    </div>
    <div :style="{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', width: '120px', position: 'absolute', top: '163px', left: '290px'}">
      ...
      <data-loader v-slot="{ results: results }" :url="`/v1/components/58b74ddd-39de-493f-84ab-9d87fcf23fee/data?type=${digitalKeyword || ''}&tag=${craneStates.supplyInputWord}&area=${currentArea ? currentArea : ''}`" method="get" :data="[[0]]">
        <digital-roll :content="{digital: results[0][0] ? results[0][0] : 0, suffix: '人'}" :options="{separator: ''}" :suffixStyle="{color: '#00fff2', fontSize: '16px', fontWeight: '400'}" :titleStyle="{color: '#ffffff', fontSize: '16px', fontWeight: '400'}" :digitalStyle="{fontSize: '20px', color: '#00fff2', fontWeight: '600', lineHeight: '32px', fontFamily: 'Oswald-Regular', format: '11', letterSpacing: '2.4px'}" />
      </data-loader>
    </div>
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/58b74ddd-39de-493f-84ab-9d87fcf23fee/data?type=${digitalKeyword || ''}&tag=${craneStates.supplyInputWord}&area=${currentArea ? currentArea : ''}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '134px', left: '1614px'}">
    ...
    <data-loader ref="high-talents-demand-change-line-chart" v-slot="{ results: supplyResults }" :url="`/v1/components/5ab74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&type=${digitalKeyword || ''}&job=${craneStates.supplyInputWord}`" method="get" :data="[[0, '暂无数据']]">
      <data-loader ref="high-talents-demand-change-line-chart" v-slot="{ results: demandResults }" :url="`/v1/components/5bb74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&type=${digitalKeyword || ''}&job=${craneStates.supplyInputWord}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '180px', position: 'absolute', top: '597px', left: '40px'}">
