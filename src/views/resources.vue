<template>
  <div class="resources" v-if="isShow">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/54b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${areaSelect}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '848px', left: '1776px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/51b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${areaSelect}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '900px', left: '1776px'}">
      {{`${results[0][0] ? results[0][0].toFixed(2) : 0}%`}}
    </data-loader>
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/52b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${areaSelect}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '952px', left: '1776px'}">
      {{`${results[0][0] ? results[0][0].toFixed(2) : 0}%`}}
    </data-loader>
