<template>
  <div class="resources">
    ...
    <data-loader ref="talents-demand-change-count-line-chart" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/50b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '230px', position: 'absolute', top: '100px', left: '1500px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/22b74ddd-39de-493f-84ab-9d87fcf23fee/data?year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{width: '380px', height: '218px', position: 'absolute', top: '792px', left: '40px'}">
    ...
    <data-loader ref="part-production-value" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/12b74ddd-39de-493f-84ab-9d87fcf23fee/data?city=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '134px', left: '130px'}">
    ...
    <data-loader ref="talent-number" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/13b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0]]" :style="{position: 'absolute', top: '214px', left: '130px'}">
    ...
    <data-loader ref="ranking_rank" v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/19b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[20, '暂无数据']]" :style="{width: '296px', height: '290px', overflow: 'scroll', position: 'absolute', top: '412px', left: '90px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/54b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '848px', left: '1776px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/51b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '900px', left: '1776px'}">
      {{`${results[0][0] ? results[0][0].toFixed(2) : 0}%`}}
    </data-loader>
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/52b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '952px', left: '1776px'}">
      {{`${results[0][0] ? results[0][0].toFixed(2) : 0}%`}}
    </data-loader>
    ...
    <data-loader v-slot="{ results: results }" :url="`http://vis.cdyoue.com:35006/v1/components/53b74ddd-39de-493f-84ab-9d87fcf23fee/data?area=${currentArea ? currentArea : ''}&year=${craneStates.year ? craneStates.year.getFullYear() : new Date().getFullYear()}`" method="get" :data="[[0, '暂无数据']]" :style="{color: '#00fff2', fontSize: '14px', fontWeight: 400, lineHeight: '20px', position: 'absolute', top: '1004px', left: '1776px'}">
      {{`${results[0][0] ? results[0][0].toFixed(2) : 0}%`}}
    </data-loader>
  </div>
</template>
